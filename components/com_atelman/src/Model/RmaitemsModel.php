...
/**
 * Methods supporting a list of Atelman records.
 *
 * @since  1.0.0
 */
class RmaitemsModel extends ListModel
{
	...
	public function __construct($config = array())
	{
		if (empty($config['filter_fields']))
		{
			$config['filter_fields'] = array(
				'id', 'a.id',
				'rma_request_id', 'a.rma_request_id',
				'rmacode', 'a.rmacode',
				'warranty_item_id', 'a.warranty_item_id',
				'product_id', 'a.product_id',
				'customer_id', 'a.customer_id',
				'requested_sn', 'a.requested_sn',
				'replacement_pn', 'a.replacement_pn',
				'replacement_sn', 'a.replacement_sn',
				'warranty_status', 'a.warranty_status',
				'description', 'a.description',
				'status', 'a.status',
				'shipping_duration', 'a.shipping_duration',
				'so_no', 'a.so_no',
				'invoice_no', 'a.invoice_no',
				'remarks', 'a.remarks',
				'replacement_date', 'a.replacement_date',
				'rma_assigned_date', 'a.rma_assigned_date',
				'received_date', 'a.received_date',
				'shipped_date', 'a.shipped_date',
				'closed_date', 'a.closed_date',
				'created_date', 'a.created_date',
				'is_import_csv', 'a.is_import_csv',
	...
	protected function loadFormData()
	{
		...
		if ($error_dateformat)
		{
			$app->enqueueMessage(Text::_("COM_ATELMAN_SEARCH_FILTER_DATE_FORMAT"), "warning");
