...
$r = Factory::getApplication()->input->get('r');

if (!empty($_SERVER['REDIRECT_PARTNER_ACCESS']) || !empty($_SERVER['PARTNER_ACCESS'])) {
    $currentArea = 1;
} elseif (strpos($_SERVER['SCRIPT_NAME'], '/administrator') !== false) {
    $currentArea = 2;
} else {
    $currentArea = 0;
}
...
$logoBrandLarge  = $this->params->get('logoBrandLarge')
    ...
    : Uri::root(false) . 'media/templates/administrator/atum/images/logos/allied_logo_white.jpg';
$loginLogo = $this->params->get('loginLogo')
    ? Uri::root(false) . $this->params->get('loginLogo')
    : Uri::root(false) . 'media/templates/administrator/atum/images/logos/allied_logo.png';
    ...
    <div id="wrapper" class="wrapper flex-grow-1">
        ...
        <div id="sidebar-wrapper" class="sidebar-wrapper px-3 pb-3">
            <div id="main-brand" class="main-brand">
                <h2>
                    <?php if ($currentArea === 1) {
                        echo "Partners and Distributors Login";
                    } elseif ($currentArea === 2) {
