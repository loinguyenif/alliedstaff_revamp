...
class UsersModel extends ListModel
{
    ...
    protected function populateState($ordering = 'a.name', $direction = 'asc')
    {
        ...
        //ifoundries
        $this->setState('filter.country', $this->getUserStateFromRequest($this->context . '.filter.country', 'filter_country', '', 'cmd'));
        $this->setState('filter.customertype', $this->getUserStateFromRequest($this->context . '.filter.customertype', 'filter_customertype', '', 'string'));
    ...
    protected function getStoreId($id = '')
    {
        ...
        $id .= ':' . $this->getState('filter.customertype');
    ...
    protected function getListQuery()
    {
        ...
        $customerType  = $this->getState('filter.customertype');
        if ($customerType) {
            if ($customerType == "ex") {
                $tex = 0;
            } elseif ($customerType == "in") {
                $tex = 1;
            }
            $query->where('is_internal=' . $tex);
        }
