...
class UserController extends FormController
{
    ...
    public function sendAcctRequest()
    {
        ...
        if ($model->sendMailRequest($post)) {
            $msg = 'SUCCESS : Your Request has been sent to Admin';
        } else {
            $msg = 'ERROR : Your Request has not been sent to Admin';
        }
        $this->setRedirect('index.php?option=com_users&view=user&layout=form_acct_request', $msg);
    }
}
