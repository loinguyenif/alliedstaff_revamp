...
namespace Atelman\Component\Atelman\Administrator\View\Country;
// No direct access
...
/**
 * View class for a single Country.
 *
 * @since  1.0.0
 */
class HtmlView extends BaseHtmlView
{
	...
	protected function addToolbar()
	{
		...
		ToolbarHelper::title(Text::_('Edit Country : ' . $this->item->country), "generic");

		// If not checked out, can save the item.
		if (!$checkedOut && ($canDo->get('core.edit') || ($canDo->get('core.create')))) {
			ToolbarHelper::save('country.save', 'Save');
			ToolbarHelper::apply('country.apply', 'Apply');
		}
