...
namespace Atelman\Component\Atelman\Administrator\View\Countries;
// No direct access
...
class HtmlView extends BaseHtmlView
{
	...
	protected function addToolbar()
	{
		...
		ToolbarHelper::title(Text::_('Country Management'), "generic");

		$toolbar = Toolbar::getInstance('toolbar');

		// Check if the form exists before showing the add/edit buttons
		$formPath = JPATH_COMPONENT_ADMINISTRATOR . '/src/View/Countries';

		if (file_exists($formPath)) {
			if ($canDo->get('core.create')) {
				$toolbar->addNew('country.add', 'Add');
			}
		}
		...
		// Set sidebar action
		Sidebar::setAction('index.php?option=com_atelman&view=countries');
	}
	...
	protected function getSortFields()
	{
		return array(
			...
			'a.`country`' => Text::_('COM_ATELMAN_COUNTRIES_COUNTRY'),
		);
	}
