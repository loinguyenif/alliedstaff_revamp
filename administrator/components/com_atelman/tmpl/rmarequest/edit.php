...
<form
	...
	method="post" enctype="multipart/form-data" name="adminForm" id="rmarequest-form" class="form-validate form-horizontal">

	
	<?php echo HTMLHelper::_('uitab.startTabSet', 'myTab', array('active' => 'request')); ?>
	<?php echo HTMLHelper::_('uitab.addTab', 'myTab', 'request', Text::_('COM_ATELMAN_TAB_REQUEST', true)); ?>
	<div class="row-fluid">
		<div class="col-md-12 form-horizontal">
			<fieldset class="adminform">
				<legend><?php echo Text::_('COM_ATELMAN_FIELDSET_REQUEST'); ?></legend>
