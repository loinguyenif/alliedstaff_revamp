...
<form
	...
	<?php echo HTMLHelper::_('uitab.addTab', 'myTab', 'product', Text::_('COM_ATELMAN_TAB_PRODUCT', true)); ?>
	<div class="row-fluid">
		<div class="col-md-12 form-horizontal">
			<fieldset class="adminform">
				<?php echo $this->form->renderField('product_no'); ?>
				<?php echo $this->form->renderField('model_no'); ?>
				<?php echo $this->form->renderField('product_name'); ?>
				<?php echo $this->form->renderField('warranty'); ?>
				<?php echo $this->form->renderField('is_previous3years'); ?>
			</fieldset>
		</div>
	</div>
