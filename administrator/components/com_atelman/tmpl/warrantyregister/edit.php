...
<form
	...
	method="post" enctype="multipart/form-data" name="adminForm" id="warrantyregister-form" class="form-validate form-horizontal">

	
	<?php echo HTMLHelper::_('uitab.startTabSet', 'myTab', array('active' => 'register')); ?>
	<?php echo HTMLHelper::_('uitab.addTab', 'myTab', 'register', Text::_('COM_ATELMAN_TAB_REGISTER', true)); ?>
	<div class="row-fluid">
		<div class="col-md-12 form-horizontal">
			<fieldset class="adminform">
				<legend><?php echo Text::_('COM_ATELMAN_FIELDSET_REGISTER'); ?></legend>
